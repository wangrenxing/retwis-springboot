 ...
 */
package com.smart.retwisj.web;

import com.smart.retwisj.domain.Post;
import com.smart.retwisj.domain.Range;
import com.smart.retwisj.domain.RetwisRepository;
import com.smart.retwisj.domain.RetwisSecurity;
import com.smart.retwisj.exception.NoSuchDataException;
...
public class RetwisController {
	...
	public Boolean loggedIn() {
		return RetwisSecurity.isSignedIn();
	}
	@ModelAttribute("loggedUser")
	public String loggedUser() {
		return RetwisSecurity.getName();
	}
